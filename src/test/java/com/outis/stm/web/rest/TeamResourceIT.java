...
class TeamResourceIT {
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team().name(DEFAULT_NAME).shortName(DEFAULT_SHORT_NAME);
        // Add required entity
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team().name(UPDATED_NAME).shortName(UPDATED_SHORT_NAME);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void putNewTeam() throws Exception {
        ...
        updatedTeam.name(UPDATED_NAME).shortName(UPDATED_SHORT_NAME);
    ...
    void fullUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.name(UPDATED_NAME).shortName(UPDATED_SHORT_NAME);
