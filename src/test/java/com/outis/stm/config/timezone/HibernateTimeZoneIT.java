package com.outis.stm.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.outis.stm.IntegrationTest;
import com.outis.stm.repository.timezone.DateTimeWrapper;
import com.outis.stm.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM stm_date_time_wrapper where id=%d", fieldName, id);
    }
