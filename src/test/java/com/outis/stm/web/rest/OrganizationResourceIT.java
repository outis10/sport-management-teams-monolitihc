...
class OrganizationResourceIT {
    ...
    public static Organization createEntity(EntityManager em) {
        Organization organization = new Organization().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        // Add required entity
    ...
    public static Organization createUpdatedEntity(EntityManager em) {
        Organization organization = new Organization().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        // Add required entity
        User user = UserResourceIT.createEntity(em);
        em.persist(user);
        em.flush();
    ...
    void putNewOrganization() throws Exception {
        ...
        updatedOrganization.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateOrganizationWithPatch() throws Exception {
        ...
        partialUpdatedOrganization.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
